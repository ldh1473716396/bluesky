...
<form class="layui-form" action="{:url('admin/start/add',['event_id'=>$event.id])}" method="post">
	...
	{volist name="conf" id="data"}
		...
		<label class="layui-form-label">{$data.start_conf_key}</label>
		<div class="layui-input-block">
		<input type="text" name="start_content[{$data.id}]" class="layui-input" required>
		</div>
		</div>
		{/if}
		...
		<label class="layui-form-label">{$data.start_conf_key}</label>
		<div class="layui-input-block">
		<textarea type="text" name="start_content[{$data.id}]" class="layui-textarea" required></textarea>
		</div>
		</div>
		{/if}
