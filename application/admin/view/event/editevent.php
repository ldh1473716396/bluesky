...
<form class="layui-form" action="{:url('admin/event/edit',array('id'=>$edit.id))}" method="post">
	
	<div class="layui-form-item">
	<label class="layui-form-label">标题</label>
	<div class="layui-input-block">
	<input type="text" name="event_title" value="{$edit.event_title}" class="layui-input" required>
	</div>
	</div>
	...
	{volist name="conf" id="data"}
		...
		<div class="layui-input-block">
		<input type="text" name="event_content[{$data.id}]" value="{if isset($edit['event_content'][$data.id])}{$edit['event_content'][$data.id]}{/if}" class="layui-input" >
		</div>
		</div>
		{/if}
		...
		<label class="layui-form-label">{$data.event_conf_key}</label>
		<div class="layui-input-block">
		<textarea type="text" name="event_content[{$data.id}]" class="layui-textarea" >{if isset($edit['event_content'][$data.id])}{$edit['event_content'][$data.id]}{/if}
		</textarea>
		</div>
		</div>
		{/if}
