...
<div class="layui-fluid">
	...
	<span class="layui-breadcrumb">
	  ...
	  <a><cite>事件配置添加</cite></a>
	</span>
	</div>
	</div>

	<div class="layui-card">
	<div class="layui-card-header">事件配置添加</div>
	<div class="layui-card-body layui-text">

	<form class="layui-form" action="{:url('admin/event_conf/add')}" method="post">
		...
		<div class="layui-input-inline">
		<input type="text" name="event_conf_key" class="layui-input" required>
		</div>
		</div>
		...
		<textarea type="text" class="layui-textarea" rows="3" name="event_conf_value" placeholder="请用“ / ”符号隔开，禁止填入“ | ”，“ * ”，“ - ” 等符号。"></textarea>
		</div>
		</div>
